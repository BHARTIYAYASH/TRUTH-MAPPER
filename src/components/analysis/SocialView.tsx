...
import type { Tweet, DetectedFallacy } from '@/lib/types';
      ...
      {isOpen && (
        ...
        >
          <div className="h-full flex flex-col">
            <div className="flex items-center justify-between px-4 py-3 sticky top-0 z-10 bg-background/80 backdrop-blur-md border-b">
              <h2 className="font-bold text-lg text-foreground flex items-center gap-2">
                Analysis & Social Pulse
              </h2>
            </div>
